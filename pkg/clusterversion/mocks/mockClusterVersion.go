...
//
//	mockgen -destination=pkg/clusterversion/mocks/mockClusterVersion.go -package=mocks github.com/openshift/managed-upgrade-operator/pkg/clusterversion ClusterVersion
//
...
func (m *MockClusterVersion) EnsureChannel(uc *v1alpha1.UpgradeConfig) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnsureChannel", uc)
	ret0, _ := ret[0].(error)
	return ret0
}

// EnsureChannel indicates an expected call of EnsureChannel.
func (mr *MockClusterVersionMockRecorder) EnsureChannel(uc any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EnsureChannel", reflect.TypeOf((*MockClusterVersion)(nil).EnsureChannel), uc)
}
